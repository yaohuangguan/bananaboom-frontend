...
export const fr = {
  ...
  blogList: {
    ...
    readArticle: 'Accéder aux Données',
    systemLog: 'Journal Système // Accès Public',
    entries: 'ENTRÉES',
    status: 'STATUT',
    online: 'EN LIGNE',
    searchPlaceholder: 'Rechercher des journaux par mots-clés...',
    filter: 'Filtre:',
    all: 'Tous',
    noLogs: 'Aucun journal trouvé',
    adjustSearch: 'Ajustez vos paramètres de recherche',
  ...
  profile: {
    ...
    active: 'Actif',
    vipBadge: 'VIP',
    downloadBackup: 'Télécharger une sauvegarde de tous vos journaux personnels au format JSON.',
    height: 'Taille (cm)',
    fitnessGoal: 'Objectif Fitness',
    barkUrl: 'URL Bark (Push)',
    barkUrlPlaceholder: 'https://api.day.app/votre-cle/...',
    timezone: 'Fuseau Horaire',
    goals: {
      cut: 'Perte de Gras (Cut)',
      bulk: 'Prise de Masse (Bulk)',
      maintain: 'Maintenir'
    },
    role: 'Autorité du Rôle',
    ...
    requestPermissionTitle: 'Demander une Permission',
    permissionKey: 'Clé de Permission',
    applyAdmin: 'Demander le Rôle Admin',
    customRequest: 'Demande de Permission Personnalisée',
    reasonLabel: 'Raison de la Demande',
    reasonPlaceholder: 'Veuillez décrire pourquoi vous avez besoin de cette permission...',
  ...
  system: {
    ...
    subtitle: 'Tableau de bord pour surveiller les ressources système et les services externes.',
    tabs: {
    ...
    roles: {
      ...
      desc: 'Description',
      perms: 'Permissions',
      save: 'Sauvegarder Rôle',
      delete: 'Supprimer Rôle'
    },
    permissions: {
      title: 'Registre des Permissions',
      add: 'Ajouter Permission',
      edit: 'Éditer Permission',
      key: 'Clé',
      name: 'Nom',
      category: 'Catégorie',
      desc: 'Description',
      save: 'Sauvegarder Permission',
  ...
  footprint: {
    ...
    stats: {
      total: 'Empreintes Totales',
      countries: 'Pays Visités',
      provinces: 'Provinces Illuminées',
      cities: 'Villes Atteintes'
    },
    add: 'Ajouter Empreinte',
    edit: 'Éditer Empreinte',
    form: {
      name: 'Nom du Lieu',
  ...
  resume: {
    ...
    educationDegree: 'BA, Études Médias Interactifs',
  ...
  chat: {
    ...
    send: 'Transmettre',
    me: 'Moi',
    welcome: 'Bienvenue sur la Passerelle',
    encrypted: 'Chiffré'
  },
  delete: {
  ...
  privateSpace: {
    ...
    fitness: {
      ...
      subtitle: 'Suivi des métriques corporelles et de performance.',
      goals: {
        cut: 'Perte de Gras',
        bulk: 'Prise de Masse',
        maintain: 'Maintenir'
      ...
      photoWall: {
        ...
        captured: '{n} Photos Capturées ce Mois',
        empty: 'Aucune photo pour cette période',
        view: 'Voir Photos du Jour',
        prev6: '6 Mois Préc.',
        next6: '6 Mois Suiv.'
      },
      stats: {
      ...
      input: {
        loggingFor: 'Enregistrement pour :',
